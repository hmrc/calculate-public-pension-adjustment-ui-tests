...
object WhichSchemeDetailsPage extends BasePage {
  ...
  def verifyPageSelectSchemeAndContinue(period: String, pensionSchemeNumber: String, pensionScheme: String) = {
    onWhichSchemeDetailsPage(period, pensionSchemeNumber)
    selectPensionScheme(pensionScheme)
    checkYourAnswersAAPeriodMap(getHeader(), pensionScheme)
    submitPage()
  }
  def verifyPageSelectNewSchemeAndContinue(period: String, pensionSchemeNumber: String) = {
    onWhichSchemeDetailsPage(period, pensionSchemeNumber)
    selectNewScheme()
    checkYourAnswersAAPeriodMap(getHeader(), "New")
    submitPage()
  }
