...
import uk.gov.hmrc.test.ui.constants.PageInformation.{PAYING_INTO_PUBLIC_PENSION_SCHEME_PAGE_HEADER, PAYING_INTO_PUBLIC_PENSION_SCHEME_PAGE_TITLE, SCOTTISH_TAX_PAYER_FROM_2016_PAGE_TITLE}
