...
class IncomeSubJourneys extends BaseSpec {
  ...
  Feature("Calculate...") {
    ...
    Scenario("Income Sub-Journeys 7", ZapTests, ISJJourney) {
    ...
    Scenario("Income Sub-Journeys 8", ZapTests, ISJJourney) {
    ...
    Scenario("Income Sub-Journeys 9", ZapTests, ISJJourney) {
    ...
    Scenario("Income Sub-Journeys 10", ZapTests, ISJJourney) {
    ...
    Scenario("Income Sub-Journeys 11", ISJJourney) {
    ...
    Scenario("Income Sub-Journeys 12", ISJJourney) {
    ...
    Scenario("Income Sub-Journeys 13", ISJJourney) {
    ...
    Scenario("Income Sub-Journeys 14", ISJJourney) {
    ...
    Scenario("Income Sub-Journeys 15", ISJJourney) {
    ...
    Scenario("Income Sub-Journeys 16", ISJJourney) {
    ...
    Scenario("Income Sub-Journeys 17", ISJJourney) {
    ...
    Scenario("Income Sub-Journeys 18", ISJJourney) {
