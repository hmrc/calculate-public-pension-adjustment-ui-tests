...
class CalculationUserJourneys extends BaseSpec {
  ...
  Feature("Calculate...") {
    ...
    Scenario("Income Sub-Journeys 11", ZapTests) {
    ...
    Scenario("Income Sub-Journeys 12", ZapTests) {
    ...
    Scenario("Income Sub-Journeys 13", ZapTests) {
    ...
    Scenario("Income Sub-Journeys 14", ZapTests) {
    ...
    Scenario("Income Sub-Journeys 15", ZapTests) {
    ...
    Scenario("Income Sub-Journeys 16", ZapTests) {
    ...
    Scenario("Income Sub-Journeys 17", ZapTests) {
    ...
    Scenario("Income Sub-Journeys 18", ZapTests) {
