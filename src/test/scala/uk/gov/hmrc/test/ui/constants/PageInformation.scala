...
object PageInformation {
  ...
  val HAD_BENEFIT_CRYSTALLISATION_EVENT_PAGE_TITLE       =
    "Have you had a benefit crystallisation event in your pension? - Calculate your public service pension adjustment - GOV.UK"
  val HAD_BENEFIT_CRYSTALLISATION_EVENT_PAGE_HEADER      = "Have you had a benefit crystallisation event in your pension?"
  ...
  val NOT_ABLE_TO_USE_THIS_SERVICE_LTA_PAGE_TITLE        =
    "Not able to use this service - Calculate your public service pension adjustment - GOV.UK"
  ...
  val PERCENTAGE_CAUSED_CHANGE_IN_CHARG_PAGE_TITLE       =
    "Has the change led to a new, increased or decreased tax charge? - Calculate your public service pension adjustment - GOV.UK"
  ...
  val LTA_PROTECTION_OR_ENHANCEMENTS_PAGE_TITLE          =
    "Do you have lifetime allowance protection or enhancements? - Calculate your public service pension adjustment - GOV.UK"
  ...
  val PROTECTION_TYPE_PAGE_TITLE                         =
    "What is your protection type? - Calculate your public service pension adjustment - GOV.UK"
  val PROTECTION_TYPE_PAGE_HEADER                        =
    "What is your protection type?"
  val PROTECTION_REFERENCE_PAGE_TITLE                    =
    "What is your protection reference? - Calculate your public service pension adjustment - GOV.UK"
  ...
  val PROTECTION_CHANGED_PAGE_TITLE                      =
    "Has your protection type or enhancement changed? - Calculate your public service pension adjustment - GOV.UK"
  ...
  val PROTECTION_CHANGED_NEW_TYPE_PAGE_TITLE             =
    "What is the new protection type or enhancement? - Calculate your public service pension adjustment - GOV.UK"
  ...
  val PROTECTION_CHANGED_NEW_REFERENCE_PAGE_TITLE        =
    "What is the reference of the new protection type or enhancement? - Calculate your public service pension adjustment - GOV.UK"
  ...
  val SCHEME_PAID_LTA_CHARGE_PAGE_TITLE                  =
    "What is the name and tax reference of the scheme that paid the lifetime allowance charge? - Calculate your public service pension adjustment - GOV.UK"
