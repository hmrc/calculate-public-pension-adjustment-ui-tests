...
object PageInformation {
  ...
  val WHAT_YOU_WILL_NEED_LTA_PAGE_TITLE                  = "Lifetime allowance - Calculate Public Pension Adjustment service - GOV.UK"
  val WHAT_YOU_WILL_NEED_LTA_PAGE_HEADER                 = "Lifetime allowance"
  val HAD_BENEFIT_CRYSTALLISATION_EVENT_PAGE_TITLE       =
    "Have you had a benefit crystallisation event in your pension? - Calculate Public Pension Adjustment service - GOV.UK"
  ...
  val DATE_OF_BENEFIT_CRYSTALLISATION_EVENT_PAGE_TITLE   =
    "What was the date of the benefit crystallisation event? - Calculate Public Pension Adjustment service - GOV.UK"
  ...
  val WHO_PAYING_EXTRA_LTA_CHARGE_PAGE_TITLE             =
    "Who is paying the extra lifetime allowance charge? - Calculate Public Pension Adjustment service - GOV.UK"
  ...
  val HOW_MUCH_PENSION_PAY_CHARGE_PAGE_TITLE             =
    "How much of the charge did your pension scheme pay? - Calculate Public Pension Adjustment service - GOV.UK"
  ...
  val HOW_MUCH_YOU_PAY_CHARGE_PAGE_TITLE                 =
    "How much of the charge did you pay? - Calculate Public Pension Adjustment service - GOV.UK"
  val HOW_MUCH_YOU_PAY_CHARGE_PAGE_HEADER                =
    "How much of the charge did you pay?"
  val CONTRIBUTED_OTHER_DB_DC_SCHEME_PAGE_TITLE          =
    "Have you contributed to any other defined benefit or defined contribution scheme? - Calculate Public Pension Adjustment service - GOV.UK"
